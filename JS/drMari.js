...
class Field {
    ...
    constructor(level, speed) {
        ...
        this.image[0].src = "../doq_mari-main/img/gameover.png";
        this.image[1].src = "../doq_mari-main/img/gameclear.png";

        this.bacteriaImage[0].src = "../doq_mari-main/img/akakin.png";
        this.bacteriaImage[1].src = "../doq_mari-main/img/aokin.png";
        this.bacteriaImage[2].src = "../doq_mari-main/img/kikin.png";
